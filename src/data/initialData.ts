...
export const initialPortfolioData: PortfolioData = {
  ...
  projects: [
    {
      ...
      heroImage: '/images/netflix_analytics_dashboard.jpg',
    ...
    },
    {
      ...
      heroImage: '/images/uber_mobility_dashboard.jpg',
    ...
    },
    {
      ...
      heroImage: '/images/youtube_nlp_summarizer.jpg',
    ...
    },
    {
      ...
      heroImage: '/images/smart_traffic_ai_cv.jpg',
  ...
  mediaLibrary: [
    ...
    {
      id: 'media-2',
      name: 'Netflix_EDA_Dashboard.jpg',
      url: '/images/netflix_analytics_dashboard.jpg',
      type: 'image',
      size: '1.2 MB',
      uploadedAt: '2026-08-10',
      usedInSection: 'Projects → Netflix Data Analysis',
      altText: 'Netflix Global Catalog Trends Dashboard',
      description: 'Analytics chart visualization for global streaming catalog distributions.'
    },
    {
      id: 'media-3',
      name: 'Uber_Demand_Spatial_Model.jpg',
      url: '/images/uber_mobility_dashboard.jpg',
      type: 'image',
      size: '980 KB',
    ...
    {
      id: 'media-4',
      name: 'YouTube_Summarizer_UI.jpg',
      url: '/images/youtube_nlp_summarizer.jpg',
      type: 'image',
      size: '1.4 MB',
      uploadedAt: '2026-08-05',
      usedInSection: 'Projects → YouTube Summarizer',
      altText: 'NLP Transcript Summarization Engine',
      description: 'NLP video breakdown and executive summary interface.'
    },
    {
      id: 'media-traffic',
      name: 'Smart_Traffic_Vision_AI.jpg',
      url: '/images/smart_traffic_ai_cv.jpg',
      type: 'image',
      size: '1.1 MB',
      uploadedAt: '2026-08-04',
      usedInSection: 'Projects → Smart Traffic Signaling System',
      altText: 'Computer Vision Real-time Traffic Optimization',
      description: 'Smart city intersection vehicle density analytics.'
    },
    {
      id: 'media-5',
